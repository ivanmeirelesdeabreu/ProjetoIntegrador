...
CREATE TABLE candidato (
    ...
    FOREIGN KEY (cd_eleicao)
        REFERENCES eleicao(cd_eleicao),

    FOREIGN KEY (cd_municipio_tse)
        REFERENCES municipio(cd_municipio_tse),

    FOREIGN KEY (cd_cargo)
        REFERENCES cargo(cd_cargo),

    FOREIGN KEY (nr_partido)
        REFERENCES partido(nr_partido),

    FOREIGN KEY (nr_federacao)
        REFERENCES federacao(nr_federacao),

    FOREIGN KEY (sq_coligacao)
    ...
    FOREIGN KEY (cd_cor_raca)
        REFERENCES cor_raca(cd_cor_raca),

    FOREIGN KEY (cd_ocupacao)
        REFERENCES ocupacao(cd_ocupacao),

    FOREIGN KEY (cd_situacao_candidatura)
        REFERENCES situacao_candidatura(cd_situacao_candidatura),

    FOREIGN KEY (cd_sit_tot_turno)
        REFERENCES situacao_turno(cd_sit_tot_turno)
);
